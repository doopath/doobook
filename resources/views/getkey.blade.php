...
@section('main')
    ...
    <form action="{{ route('getkey.register') }}" name="key" class="get_key" method="post">
        @csrf
        <div>
            <p class="input__label">* Enter your email</p>
            <input type="email" class="key__email" required name="email" placeholder="example: johnjohnson@gmail.com">
        </div>

        <div>
            <p class="input__label">* Enter your first name</p>
            <input type="text" class="key__name" required name="name" placeholder="example: John">
        </div>

        <div>
            <p class="input__label">* Enter your surname</p>
            <input type="text" class="key__surname" required name="surname" placeholder="example: Johnson">
        </div>

        <div>
            <p class="input__label">* Enter your age</p>
            <input type="text" class="key__age" required name="age" placeholder="example: 21">
        </div>
        ...
        <div class="key__links__container">
            ...
            <ul class="key__links-list">
                <li><input type="text" class="key__links-list__item" name="link1" placeholder="example: https://freelancehunt.com/freelancer/johnny.html"></li>
                <li><input type="text" class="key__links-list__item" name="link2" placeholder="example: https://freelancehunt.com/freelancer/johnny.html"></li>
                <li><input type="text" class="key__links-list__item" name="link3" placeholder="example: https://freelancehunt.com/freelancer/johnny.html"></li>
                <li><input type="text" class="key__links-list__item" name="link4" placeholder="example: https://freelancehunt.com/freelancer/johnny.html"></li>
                <li><input type="text" class="key__links-list__item" name="link5" placeholder="example: https://freelancehunt.com/freelancer/johnny.html"></li>
            </ul>
        </div>
